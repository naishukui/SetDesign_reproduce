---
title: "simulation on real data- linear outcome-sample size=2k"
...
df5<-get(load("realCwT0.05_2k.Rdata"))
df6<-get(load("realCwT0.2_2k.Rdata"))
...
```{r combine2_linear2k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine1_linear2k,echo=FALSE, cache=FALSE, warning=FALSE}
# Create a dummy plot using data from any of the chunks (e.g., dfnew1)
# to extract the legend
