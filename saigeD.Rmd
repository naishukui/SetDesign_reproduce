---
title: "simulation on real data- binary outcome - SAIGE-GENE"
...
knitr::opts_chunk$set(fig.path = "/Users/nkui/Library/CloudStorage/OneDrive-InsideMDAnderson/SAIGE/output/")#, fig.width = 6, fig.height = 8)

library(dplyr)

setwd("/Users/nkui/Library/CloudStorage/OneDrive-InsideMDAnderson/SAIGE/output/")
df0.2<-get(load("saige_0.2d.Rdata"))
df0.05<-get(load("saige_0.05d.Rdata"))
