---
title: "simulation on real data- binary outcome-sample size=500"
...
df1<-get(load("realDwT0.2_500.Rdata"))
df2<-get(load("realDwT0.05_200.Rdata"))
...
```{r combine1-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine2-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine3-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine4-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine5-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine6-binary-500,echo=FALSE, cache=FALSE, warning=FALSE}
