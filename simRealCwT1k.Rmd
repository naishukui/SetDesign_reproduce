---
title: "simulation on real data- linear outcome-sample size=1k"
...
df5<-get(load("realCwT0.05_1k.Rdata"))
df6<-get(load("realCwT0.2_1k.Rdata"))
...
fig2_panels <- ggarrange(plotlist = plots, ncol = 4, nrow = 1, labels = c("A", "B", "C", "D"))
```
...
fig3_panels <- ggarrange(plotlist = plots, ncol = 4, nrow = 1, labels = c("A", "B", "C", "D"))
```
...
fig4_panels <- ggarrange(plotlist = plots, ncol = 4, nrow = 1, labels = c("E", "F", "G", "H"))
```
...
fig6_panels <- ggarrange(plotlist = plots, ncol = 4, nrow = 1, labels = c("A", "B", "C", "D"))
