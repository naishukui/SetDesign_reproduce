# # For binary outcome, MAF:0.17-0.24, calculates power for true and misspecified  models using SKAT
...
# Save to a file named by the job index to prevent overwriting
output_filename <- paste0("realDwT0.2_2k_", job_index, ".csv")
