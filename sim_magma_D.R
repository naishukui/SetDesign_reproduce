# For binary outcome, prepare genotype and phenotype data for true and misspecified  models in order to run MAGMA
library(gdsfmt)
library(SeqArray)
library(STAAR)
library(SKAT)
...
pheno_<- function(beta0, es1, es2, Gc, Gc2, G, G2, causal_indices, runs, n, k, es_fixed, es_fixed_name) {
  ...
  output_path <- paste0("/rsrch6/home/biostatistics/nkui/magma/maf0.05/","job",job_index)
