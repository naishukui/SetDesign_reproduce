---
title: "simulation on real data- linear outcome-SAIGE"
...
knitr::opts_chunk$set(fig.path = "/Users/nkui/Library/CloudStorage/OneDrive-InsideMDAnderson/SAIGE/output/continuous/")#, fig.width = 6, fig.height = 8)

library(dplyr)
setwd("/Users/nkui/Library/CloudStorage/OneDrive-InsideMDAnderson/SAIGE/output/")
df0.05<-get(load("saige_0.05c.Rdata"))
df0.2<-get(load("saige_0.2c.Rdata"))
