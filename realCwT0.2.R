# # For continuous outcome, MAF:0.17-0.24, calculates power for true and misspecified  models using SKAT
...
output_filename <- paste0("realCwT0.2_1k_", current_es_fixed_name, "_", job_index, ".csv")
