---
title: "simulation on real data- binary outcome-sample size=1k"
...
df1<-get(load("realDwT0.2.Rdata"))
df2<-get(load("realDwT0.05.Rdata"))
...
```{r combine1-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine2-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine3-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine4-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine5-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
...
```{r combine6-binary-1k,echo=FALSE, cache=FALSE, warning=FALSE}
